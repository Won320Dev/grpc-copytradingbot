...
// Bot Config
export const BOT_NAME = "LightningCopyTrading_bot";
export const BOT_ID = "LightningCopyTrading_bot";
export const BOT_TOKEN = '7296128476:AAGewqzXyUpsGHWPAycD_ALFg8QqfboT-EM';
